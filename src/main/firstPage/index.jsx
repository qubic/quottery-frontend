...
function FirstPage() {
  ...
  return (
    <div className='px-[130px]'>
      ...
      <div className=' flex justify-between items-center mt-[48px] px-[100px]'>
      ...
      <div className=' mt-[16px] grid grid-cols-3 justify-center items-center gap-[16px] mb-[100px] px-[100px]'>
